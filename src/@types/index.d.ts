...
declare module "handler.djs" {
  ...
  class CommandBuilder extends Base {
    ...
    public setGlobal(): CommandInterface;
    public setCooldown(cooldown: (String | Number)): CommandInterface
    public setOwners(owners: Boolean): CommandInterface;
    public setDisabled(disabed: Boolean): CommandInterface;
    public setPermissions(permissions: Array<PermissionResolvable> | PermissionResolvable): CommandInterface;
